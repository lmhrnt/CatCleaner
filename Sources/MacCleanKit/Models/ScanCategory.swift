...
public enum ScanCategory: String, CaseIterable, Identifiable, Sendable {
    ...
    public var displayName: String {
        ...
        case .ideCaches: L10n.tr("集成开发环境与编辑器缓存", "IDE & Editor Caches", "Кэш IDE и редакторов")
        case .aiToolCaches: L10n.tr("人工智能工具缓存", "AI Tool Caches", "Кэш AI-инструментов")
    ...
    public var subtitle: String {
        ...
        case .universalBinaries: L10n.tr("应用程序二进制中未使用的处理器架构切片。", "Unused CPU slices inside app binaries.", "Неиспользуемые срезы архитектур CPU в бинарных файлах приложений.")
        ...
        case .aiToolCaches: L10n.tr("人工智能编码工具的缓存（Claude、Codex）；不含历史与会话。", "Caches from AI coding tools (Claude, Codex). History and sessions excluded.", "Кэши AI-инструментов для программирования (Claude, Codex). История и сеансы не затрагиваются.")
